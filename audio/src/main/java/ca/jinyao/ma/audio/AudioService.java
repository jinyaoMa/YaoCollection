...
import ca.jinyao.ma.audio.cachers.ImageCacher;
import ca.jinyao.ma.audio.cachers.LyricCacher;
...
import ca.jinyao.ma.audio.cores.AudioPlayer;
import ca.jinyao.ma.audio.widgets.AboutWidget;
import ca.jinyao.ma.audio.widgets.AlbumDetailWidget;
import ca.jinyao.ma.audio.widgets.ArtistDetailWidget;
import ca.jinyao.ma.audio.widgets.ControllerWidget;
import ca.jinyao.ma.audio.widgets.LyricWidget;
import ca.jinyao.ma.audio.widgets.PlaylistBrowserWidget;
import ca.jinyao.ma.audio.widgets.PlaylistDetailWidget;
import ca.jinyao.ma.audio.widgets.QuickAccessWidget;
import ca.jinyao.ma.audio.widgets.SearchBrowserWidget;
import ca.jinyao.ma.audio.widgets.SettingWidget;
...
public class AudioService extends Service {
    ...
    private void setNotifyMessage(Bitmap cover, String title, String artist) {
        builder.setSmallIcon(R.mipmap.ic_icon_music)
                .setLargeIcon(cover)
    ...
    public void onCreate() {
        ...
        setupNotification();
        setNotifyMessage(R.mipmap.ic_icon_music, TAG, TAG);
        showNotification();
