...
public class AboutWidget implements View.OnTouchListener, View.OnClickListener {
    ...
    private void initFloatWindow() {
        ...
        icon = mFloatLayout.findViewById(R.id.icon);
        tvName = mFloatLayout.findViewById(R.id.tvName);
        tvVersion = mFloatLayout.findViewById(R.id.tvVersion);
        tvAuthor = mFloatLayout.findViewById(R.id.tvAuthor);
        tvSource = mFloatLayout.findViewById(R.id.tvSource);
        tvThanks = mFloatLayout.findViewById(R.id.tvThanks);
