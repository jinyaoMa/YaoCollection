...
import ca.jinyao.ma.audio.adapters.AlbumListAdapter;
...
public class AlbumDetailWidget implements View.OnTouchListener, View.OnClickListener, Album.AsyncListener, AdapterView.OnItemClickListener {
    ...
    private void initFloatWindow() {
        ...
        lvSongs = mFloatLayout.findViewById(R.id.lvSongs);
        artistContainer = mFloatLayout.findViewById(R.id.artistContainer);
